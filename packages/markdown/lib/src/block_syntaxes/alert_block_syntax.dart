...
class AlertBlockSyntax extends BlockSyntax {
  ...
  // Patched: `(.*)*` catastrophically backtracks on long lines (quadratic →
  // exponential), freezing the transcript. `.*` is semantically identical for
  // matching alert content but linear.
